...
>> temp.ps1 echo $web.DownloadFile('https://github.com/Helwor/Hel-Chobby/archive/main.zip', 'hel_chobby.zip')
>> temp.ps1 echo $shell = New-Object -ComObject Shell.Application
>> temp.ps1 echo $shell.Namespace((Get-Location).Path).CopyHere($shell.Namespace((Get-Item 'hel_chobby.zip').FullName).Items(), 16)
>> temp.ps1 echo Start-Sleep 2
>> temp.ps1 echo Remove-Item 'hel_chobby.zip'
