...
curl_auth=(-H "User-Agent: Hel-Chobby-Updater")
...
wget -q --show-progress -O helchobby.zip 'https://github.com/Helwor/Hel-Chobby/archive/main.zip' && echo "" || {
    echo "Download failed. Aborting."
    exit 1
}

unzip -qo helchobby.zip || {
